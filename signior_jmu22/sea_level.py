...
class sea_level(dml.Algorithm):
  ...
  reads = []
  writes = ['signior_jmu22_zhangyb.sea_level']
  ...
  def execute(trial = False):
    ...
    repo['signior_jmu22_zhangyb.sea_level'].insert_many(sea_level_dict)
    repo['signior_jmu22_zhangyb.sea_level'].metadata({'complete': True})

    print(repo['signior_jmu22_zhangyb.sea_level'].metadata())
